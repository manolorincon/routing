...
class ComunasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comuna" do
    assert_difference('Comuna.count') do
      post comunas_url, params: { comuna: { comuna: @comuna.comuna, region: @comuna.region } }
    end
  ...
  test "should update comuna" do
    patch comuna_url(@comuna), params: { comuna: { comuna: @comuna.comuna, region: @comuna.region } }
